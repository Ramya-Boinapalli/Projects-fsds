...
st.title('Ms. Ramya Boinapalli Seaborn Bootcamp - Tips Data Visualization App')
...
def line_plot(ax):
    sns.lineplot(data=tips, x='size', y='total_bill', hue='sex', ax=ax)
    ax.set_title("Line plot of Size vs Total Bill")
